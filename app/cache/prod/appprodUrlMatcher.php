...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // inra2013_urz_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Inra2013\\urzBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'inra2013_urz_default_index'));
        }
        ...
        if ($pathinfo === '/Admin/Show') {
            return array (  '_controller' => 'Inra2013\\urzBundle\\Controller\\AgentController::ShowAgentAction',  '_route' => 'Inra2013urzBundle_ShowAgent',);
        }
