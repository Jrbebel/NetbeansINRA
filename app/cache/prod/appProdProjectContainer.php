...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/Inra2013/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/Inra2013/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once '/var/www/Inra2013/app/cache/prod/jms_diextra/doctrine/EntityManager_50f5952edf95f.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_954c0d82797366e36807e7375bd6b28f');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_954c0d82797366e36807e7375bd6b28f');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_954c0d82797366e36807e7375bd6b28f');
        ...
        $f->setProxyDir('/var/www/Inra2013/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50f5952edf95f_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/Inra2013/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/Inra2013/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_SUPER_ADMIN'), 'ROLE_ADMIN_LABORATIN' => array(0 => 'ROLE_ADMIN_LABO'), 'ROLE_LABORANTIN' => array(0 => 'ROLE_LABO'), 'ROLE_CHERCHEUR' => array(0 => 'ROLE_CHERCH')));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/Inra2013/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/Inra2013/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/Inra2013/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/Inra2013/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/Inra2013/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/Inra2013/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/Inra2013/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/Inra2013/app/cache/prod',
            ...
            'session.save_path' => '/var/www/Inra2013/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/Inra2013/app/config/routing.yml',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_ADMIN_LABORATIN' => array(
                    0 => 'ROLE_ADMIN_LABO',
                ),
                'ROLE_LABORANTIN' => array(
                    0 => 'ROLE_LABO',
                ),
                'ROLE_CHERCHEUR' => array(
                    0 => 'ROLE_CHERCH',
                ),
            ),
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/Inra2013/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/var/www/Inra2013/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/var/www/Inra2013/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/Inra2013/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/Inra2013/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/Inra2013/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/Inra2013/app/cache/prod/jms_diextra/doctrine/EntityManager_50f5952edf95f.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50f5952edf95f_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/Inra2013/app/cache/prod/jms_security',
