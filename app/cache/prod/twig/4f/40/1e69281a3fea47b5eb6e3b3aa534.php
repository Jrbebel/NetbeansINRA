...
";
        ...
        ";
                // line 16
                if (($this->getAttribute((isset($context["xls"]) ? $context["xls"] : null), "getColumn", array(), "method") != "I")) {
                    // line 17
                    echo "        <td>";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["xls"]) ? $context["xls"] : null), "getCalculatedValue", array(), "method"), "html", null, true);
                    echo "</td>
        ";
                } else {
                    // line 19
                    echo "         <td>";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["xls"]) ? $context["xls"] : null), "getValue", array(), "method"), "html", null, true);
                    echo "</td>
        ";
                }
                // line 21
