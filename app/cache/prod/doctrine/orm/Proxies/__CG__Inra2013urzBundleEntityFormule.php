 ...
 */
class Formule extends \Inra2013\urzBundle\Entity\Formule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setFormuMath($formuMath);
    }

    public function getFormuMath()
    {
        $this->__load();
        return parent::getFormuMath();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'FormuMath', 'Champs');
    }
