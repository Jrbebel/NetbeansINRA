 ...
 */
class CategorieAnalyse extends \Inra2013\urzBundle\Entity\CategorieAnalyse implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'Nom', 'TypeCategorie');
    }
