 ...
 */
class Eosino extends \Inra2013\urzBundle\Entity\Eosino implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'Eosino_lu', 'Eosino_val', 'CodeLabo');
    }
