 ...
 */
class Echantillon extends \Inra2013\urzBundle\Entity\Echantillon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setTypeEchanti($typeEchanti);
    }

    public function getTypeEchanti()
    {
        $this->__load();
        return parent::getTypeEchanti();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'Intitulé', 'TypeEchanti');
    }
