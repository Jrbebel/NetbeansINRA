 ...
 */
class Animal extends \Inra2013\urzBundle\Entity\Animal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'NomAnimal', 'Sexe', 'dateNaissance', 'Espece');
    }
