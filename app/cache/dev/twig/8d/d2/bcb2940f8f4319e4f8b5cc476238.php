    ...
    <tbody>
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Encours"]) {
                // line 37
                echo "            <tr class=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["ValideChercheur"]) ? $context["ValideChercheur"] : $this->getContext($context, "ValideChercheur")), "class"), $this->getAttribute((isset($context["Encours"]) ? $context["Encours"] : $this->getContext($context, "Encours")), "Validation")), "html", null, true);
                echo "\">
                <td>";
                // line 38
                ...
                ";
                // line 39
                if (($this->getAttribute((isset($context["Encours"]) ? $context["Encours"] : $this->getContext($context, "Encours")), "Validation") == 2)) {
                    // line 40
                    echo "                <td><a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("Inra2013Bundle_VoirAnalyseChercheur", array("NumProtocole" => $this->getAttribute((isset($context["Encours"]) ? $context["Encours"] : $this->getContext($context, "Encours")), "id"))), "html", null, true);
                    echo "\" >";
               ...
               ";
                ...
                echo "</td>  
                    <td>";
                // line 46
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["ValideChercheur"]) ? $context["ValideChercheur"] : $this->getContext($context, "ValideChercheur")), "info"), $this->getAttribute((isset($context["Encours"]) ? $context["Encours"] : $this->getContext($context, "Encours")), "Validation")), "html", null, true);
                echo "</td>
                </tr> 
