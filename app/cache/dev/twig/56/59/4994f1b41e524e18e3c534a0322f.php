...
<html lang=\"fr\">
    ...
    <body>
        ...
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "Accueil"), "Titre"), "html", null, true);
        echo "</h1></div>
            </div> 
...
";
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        echo " ><i class=\"icon-home icon-white\"></i> Accueil</a></li>
                                    <li><a href=";
        // line 60
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "Accueil"), "Lien"), "PremierLien"), "html", null, true);
        echo "><i class=\"icon-barcode\"></i> ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "Accueil"), "Lien"), "ItemPremier"), "html", null, true);
        echo "</a></li>
                                    <li><a href=";
        // line 61
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "Accueil"), "Lien"), "DeuxiemeLien"), "html", null, true);
        echo "><i class=\"icon-book \"></i> ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "Accueil"), "Lien"), "ItemDeuxieme"), "html", null, true);
        echo "</a></li>
