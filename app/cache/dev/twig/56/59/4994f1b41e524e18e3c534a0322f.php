        ...
        echo "
                    ...
                    <script>
                        \$(document).ready(function() {
                            ...
                            \$(\"ul.nav li\").click(
                                    function() {
                                        \$(\"ul.nav li\").addClass(\"actif\");
                                        \$(\"ul.nav li\").prevAll(\".actif\").removeClass(\"actif\");
                                        \$(\"ul.nav li\").nextAll(\".actif\").removeClass(\"actif\");
